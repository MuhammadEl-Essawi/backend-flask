...
Revision ID: 6bbd281dfc27
Revises: 1a0bf191c07f
Create Date: 2025-12-04 15:10:48.662495
...
revision = '6bbd281dfc27'
down_revision = '1a0bf191c07f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('favorite', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_favorite_car_id'), ['car_id'], unique=False)
    ...
    with op.batch_alter_table('car', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('car_license_image', sa.String(length=255), nullable=True))
        batch_op.add_column(sa.Column('features', sa.String(length=500), nullable=True))
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('payout_details', sa.String(length=255), nullable=True))
        batch_op.add_column(sa.Column('billing_country', sa.String(length=100), nullable=True))
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_column('payout_details')
    ...
    with op.batch_alter_table('car', schema=None) as batch_op:
        ...
        batch_op.drop_column('car_license_image')
    ...
    with op.batch_alter_table('favorite', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_favorite_car_id'))
